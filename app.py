...
# ─── CONFIG ───────────────────────────────────────────────────────────────────
API_KEY = "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"
...
with col1:
    processo = st.text_input("Número do processo", placeholder="Ex: 0026489-12.2024.5.07.0017")
with col2:
    data_pub = st.date_input("Data da publicação", value=None, format="DD/MM/YYYY")

cliente = st.selectbox("Nome do cliente", CLIENTES)
